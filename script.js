...
var computerOverlay = document.getElementById('overlay-computer'),
    vsCodeOverlay = document.getElementById('overlay-vscode');

computerOverlay.style.transform = "scale(1)";
document.getElementById('a1').style.display = "block";

vsCodeOverlay.style.transform = "scale(1)";
document.getElementById('a1').style.display = "block";
...
function opencom() {
    computerOverlay.style.transform = "scale(1)";
    computerOverlay.getElementById('a1').style.display = "block";
}
...
function closevscode() {
    vsCodeOverlay.style.transform = "scale(0)";
    vsCodeOverlay.getElementById('a1').style.display = "block";
}
...
function closeopenvscode() {
    vsCodeOverlay.style.transform = "scale(0)";
    vsCodeOverlay.getElementById('a1').style.display = "block";
    vsCodeOverlay.getElementById('a1').style.borderBottom = '2px solid #76b9ed';
}
...
var windowsdiv = document.getElementById('overlay-computer'),
    vscodediv = document.getElementById('overlay-vscode'),
...
mouseclick.addEventListener('mousedown', function (e) {
    ...
    console.log(e)
    offset = [
        windowsdiv.offsetLeft - e.clientX,
        windowsdiv.offsetTop - e.clientY
    ];
}, true);
var isDown = false;
...
document.addEventListener('mousemove', function (event) {
    ...
    if (isDown) {
        ...
        windowsdiv.style.left = (mousePosition.x + offset[0]) + 'px';
        windowsdiv.style.top = (mousePosition.y + offset[1]) + 'px';
    }
}, true);

var resizer = document.getElementsByClassName('resizer')[0];
resizer.addEventListener('mousedown', initDrag, false);
windowsdiv.onresize = function () {
    resizer.style.bottom = 0;
    resizer.style.right = 0;
}

vscodediv.onresize = function () {
    resizer.style.bottom = 0;
    resizer.style.right = 0;
}
...
vscodediv.onscroll = function () {
    resizer.style.bottom = (0 - div.scrollTop) + "px";
    resizer.style.right = 0;
}

windowsdiv.onscroll = function () {
    resizer.style.bottom = (0 - div.scrollTop) + "px";
    resizer.style.right = 0;
}

function maxvscode() {
    vscodediv.style.width = "100%";
    vscodediv.style.top = "0";
    vscodediv.style.left = "0";
    vscodediv.style.height = "95.3vh";
    document.getElementById('upervscode').style.display = "none";
    document.getElementById('returnvscode').style.display = "inline";
}

function upercom() {
    windowsdiv.style.width = "100%";
    windowsdiv.style.top = "0";
    windowsdiv.style.left = "0";
    windowsdiv.style.height = "95.3vh";
    document.getElementById('upercam').style.display = "none";
    document.getElementById('returncam').style.display = "inline";
}

function returncom() {
    windowsdiv.style.width = "70%";
    windowsdiv.style.top = "20%";
    windowsdiv.style.left = "15%";
    windowsdiv.style.height = "60%";
    document.getElementById('returncam').style.display = "none";
    document.getElementById('upercam').style.display = "inline";
}

function returnvsacode() {
    vscodediv.style.width = "70%";
    vscodediv.style.top = "20%";
    vscodediv.style.left = "15%";
    vscodediv.style.height = "60%";
    document.getElementById('returnvscode').style.display = "none";
    document.getElementById('returnvscode').style.display = "inline";
}
